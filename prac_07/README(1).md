...
- First, I learned in this course that "clean code" must not have too many complex and difficult to understand comments
Second, I learned in this course that "clean code" must be named accurately and briefly, so that the reviewer can understand my code more clearly
Third, I learned in this course that "clean code" must be neatly formatted with no extra lines or Spaces

- Links to the Programming Patterns page and the CP1404 Practicals instructions repo.
【my code】https://github.com/ZhixingLi04/CP1404-practicals/tree/prac_07_feedback/prac_07
Please "Reformat Code" to ensure your formatting is correct before you finish and commit your README.

# Practical 07

# Introduction about myself
My name is Zhixing Li, 19 year-old-boy, this is link my own github about 【my code】https://github.com/ZhixingLi04/CP1404-practicals/tree/prac_07_feedback/prac_07
...
###
This is a link about my prac 07 code 【my code】https://github.com/ZhixingLi04/CP1404-practicals/tree/prac_07_feedback/prac_07
# Walkthrough Example
